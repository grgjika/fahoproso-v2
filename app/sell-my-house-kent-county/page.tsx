...
export const metadata: Metadata = {
  title: "Sell My House in Kent County, MI | FAHOPROSO",
  description:
    "Looking to sell your house in Kent County, Michigan? FAHOPROSO provides fair property solutions for homeowners looking to sell quickly and confidently.",
  keywords: [
    "sell my house Kent County",
    "cash home buyers Kent County",
    "sell my house fast Kent County",
      ...
      <main className="pt-24">
        ...
        <section className="relative flex min-h-[650px] items-center overflow-hidden">
          <Image
            ...
            alt="Sell your house in Kent County"
            fill
            priority
          ...
          <div className="relative mx-auto w-full max-w-7xl px-6 py-24 text-white">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                We proudly serve homeowners throughout Kent County by providing
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
        ...
        <p className="mt-4 leading-8 text-slate-600">
          Based in West Michigan, we understand the Kent County housing market
...
<section className="bg-slate-100 py-24">
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto max-w-3xl text-center">
      ...
      <p className="mt-8 text-lg leading-8 text-slate-600">
        Homeowners throughout Kent County contact FAHOPROSO for many different
...
<section className="bg-white py-24">
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto max-w-3xl text-center">
      ...
      <p className="font-semibold uppercase tracking-[0.25em] text-[#C9A227]">
        Serving Communities Across Kent County
      </p>

      <h2 className="mt-4 text-4xl font-bold text-[#14213D] md:text-5xl">
        Proudly Serving Homeowners Throughout Kent County
      </h2>

      <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-[#C9A227]" />

      <p className="mt-8 text-lg leading-8 text-slate-600">
        FAHOPROSO proudly serves homeowners throughout Kent County. Whether
        you're located in a large city, a growing suburb, or a small community,
        we're happy to discuss your property and explore the options available
        to you.
      </p>
  ...
  <div className="mx-auto max-w-5xl px-6">
    ...
    <div className="mt-14 space-y-6">
      ...
      <article className="rounded-2xl bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 leading-8 text-slate-600">
          We proudly serve Kent County and are expanding throughout West
...
<section className="bg-[#14213D] py-24 text-white">
  <div className="mx-auto max-w-5xl px-6 text-center">
    ...
    <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
      We proudly serve homeowners throughout Kent County and are expanding
