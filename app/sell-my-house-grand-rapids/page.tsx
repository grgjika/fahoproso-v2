...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sell my house fast Grand Rapids",
    "real estate investor Grand Rapids",
    "we buy houses Grand Rapids",
  ],
};

export default function SellMyHouseGrandRapidsPage() {
  return (
    <>
      <Navbar />
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
        ...
        <p className="mt-4 leading-8 text-slate-600">
          Based in West Michigan, we understand the Grand Rapids housing market
...
<section className="bg-slate-100 py-24">
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto max-w-3xl text-center">
      ...
      <p className="mt-8 text-lg leading-8 text-slate-600">
        Homeowners throughout Grand Rapids contact FAHOPROSO for many different
...
<section className="bg-white py-24">
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto max-w-3xl text-center">
      ...
      <p className="font-semibold uppercase tracking-[0.25em] text-[#C9A227]">
        Serving Communities Across Grand Rapids
      </p>

      <h2 className="mt-4 text-4xl font-bold text-[#14213D] md:text-5xl">
        Proudly Serving Homeowners Throughout Grand Rapids
      </h2>

      <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-[#C9A227]" />

      <p className="mt-8 text-lg leading-8 text-slate-600">
        FAHOPROSO proudly serves homeowners throughout Grand Rapids, including 
  ...
  <div className="mx-auto max-w-5xl px-6">
    ...
    <div className="mt-14 space-y-6">
      ...
      <article className="rounded-2xl bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 leading-8 text-slate-600">
          We proudly serve Grand Rapids and are expanding throughout West
...
<section className="bg-[#14213D] py-24 text-white">
  <div className="mx-auto max-w-5xl px-6 text-center">
    ...
    <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
      We proudly serve homeowners throughout Grand Rapids and are expanding
